...
const STYLES = {
    ...
    tip: {
        wrapper:
            'bg-purple-50 border-purple-400 dark:bg-purple-950/40 dark:border-purple-700',
...
export default function CalloutBox({
    ...
    return (
        <div
            className={`mx-4 my-6 rounded-r-lg border-l-4 px-4 py-3 ${s.wrapper}`}
        >
            {(title || showIcon) && (
            ...
            <p
                className={`text-sm leading-relaxed whitespace-pre-wrap ${s.text}`}
            >
                {content}
            </p>
        </div>
