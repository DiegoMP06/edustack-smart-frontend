...
export default function Quote({
    ...
    return (
        <blockquote
            className={`mx-4 my-6 rounded border-l-4 py-3 pr-4 pl-6 text-lg ${STYLES[variant]}`}
        >
            <p className="text-justify leading-normal">{children}</p>
            {(author || source) && (
...
export const QuoteConfig: ComponentConfig<QuoteProps> = {
    ...
    fields: {
        children: {
            type: 'textarea',
            label: 'Cita',
            placeholder: 'Escribe aquí tu cita...',
        },
        variant: {
            label: 'Estilo',
            type: 'select',
        ...
        author: {
            ...
            placeholder: 'Escribe aquí el autor...',
        },
        source: {
            type: 'text',
            label: 'Fuente (Opcional)',
            placeholder: 'Escribe aquí la fuente...',
        },
    },
